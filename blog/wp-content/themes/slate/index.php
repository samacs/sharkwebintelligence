			...
			<div class="container">					
				...
				<div class="content">
					...
					<div class="navigation">
						<div class="alignleft"><?php next_posts_link( __('&larr; Older Entries','slate') ); ?></div>
						<div class="alignright"><?php previous_posts_link( __('Newer Entries &rarr;','slate') ); ?></div>
					</div>
					
					<?php endif; ?>
					
					<?php if(is_404()) { ?>
						<h4><?php _e('Sorry, but the page you are looking for is no longer here. Please use the navigations or the search to find what what you are looking for.','slate'); ?></h4>
